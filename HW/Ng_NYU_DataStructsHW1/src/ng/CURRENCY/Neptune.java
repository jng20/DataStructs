...
public class Neptune extends Currency {
	...
	public double toEarthDollars(double amount) {
		...
		double ret = 0;
		ret = amount / Exchangeable.NeptuneNuggets;
		return ret;
	}
	...
	public double fromEarthDollars(double EarthDollars) {
		// TODO Auto-generated method stub
		double ret =0;
		ret = EarthDollars * Exchangeable.NeptuneNuggets;
		return ret;
	}
	...
	public void exchange(Currency other, double amount) {
		...
		if(amount > this.getTotalFunds()) {
			System.out.println("Uh oh - Neptune only has an available balance of $" + df.format(this.getTotalFunds()) + ", which is less than $" + df.format(amount) + "!\n");
			return;
		}
		...
		System.out.println("Neptune has a total of $" + df.format(this.getTotalFunds()) + " " + this.getCurrencyName());
